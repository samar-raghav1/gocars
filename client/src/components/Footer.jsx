...
const Footer = () => {
  return (
       ...
       <div className='text-gray-500 text-sm mt-60 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-8 md:gap-6 items-start pb-6 border-borderColor border-b'>
                <div>
                    <img src={assets.car_site_logo}alt="logo" className=' h-8 md:h-9' />
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5 text-sm'>
                        <li><a href="#">H1234 Luxury Drive</a></li>
                        <li><a href="#">San Francisco, CA 94107</a></li>
                        <li><a href="#">+91 1234567890</a></li>
                        <li><a href="#">goCars.in</a></li>
                    </ul>
                </div>
                 </div>
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} <a href="">goCars</a>. All rights reserved.</p>
